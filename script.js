...
const animatedElements = document.querySelectorAll(
  ".about-text, .service, .testimonials, .clients, .timeline, .blog-posts, article"
);
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  music.volume = 0.5; // 0.0 - 1.0 (atur sesuai selera)

  const tryPlay = () => {
    music.play().catch(() => {
      // Autoplay diblokir, tunggu user interaksi pertama
